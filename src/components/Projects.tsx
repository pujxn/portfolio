...
function Marquee() {
  const text = 'REACT · TYPESCRIPT · JAVASCRIPT (ES6+) · NEXT.JS · HTML · CSS · TANSTACK QUERY · TANSTACK ROUTER · REDUX · ZUSTAND · ZOD · TAILWIND CSS · MATERIAL UI · SHADCN/UI · FRAMER MOTION · REACT PROFILER · WEB VITALS · MEMOIZATION · OPTIMISTIC UI · REACTFLOW · REACT-D3.JS · NODE.JS · EXPRESS · POSTGRESQL · PYTHON · SQL · REST APIS · VITEST · REACT TESTING LIBRARY · FIGMA · VITE · GIT · '
  return (
    <div
      style={{
        overflow: 'hidden',
